...
var handleObservation = (entries) => entries.forEach(({
  target,
  contentRect
}) => {
...
var useScroll = (_ref = {}) => {
  let {
    container
  } = _ref, springOptions = _objectWithoutPropertiesLoose(_ref, _excluded$5);
  const [scrollValues, api] = useSpring(() => _extends3({
    scrollX: 0,
    scrollY: 0,
    scrollXProgress: 0,
    scrollYProgress: 0
...
var _excluded$4 = ["container"];
var useResize = (_ref) => {
  let {
    container
  } = _ref, springOptions = _objectWithoutPropertiesLoose(_ref, _excluded$4);
  const [sizeValues, api] = useSpring(() => _extends3({
    width: 0,
    height: 0
  }, springOptions), []);
  useIsomorphicLayoutEffect(() => {
...
var _excluded$3 = ["to", "from"];
var _excluded2 = ["root", "once", "amount"];
var defaultThresholdOptions = {
  any: 0,
  all: 1
};
function useInView(props, args) {
  const [isInView, setIsInView] = (0, import_react3.useState)(false);
  ...
  const {
    to: to3 = {},
    from = {}
  } = springsProps, restSpringProps = _objectWithoutPropertiesLoose(springsProps, _excluded$3);
  const intersectionArguments = propsFn ? args : props;
  const [springs, api] = useSpring(() => _extends3({
    from
  }, restSpringProps), []);
  useIsomorphicLayoutEffect(() => {
    ...
    const _ref = intersectionArguments != null ? intersectionArguments : {}, {
      ...
      once: once2,
      amount = "any"
    } = _ref, restArgs = _objectWithoutPropertiesLoose(_ref, _excluded2);
    ...
    const observer2 = new IntersectionObserver(handleIntersection, _extends3({
...
//# sourceMappingURL=chunk-LXEBJQKU.js.map
